...
def upgrade() -> None:
    ...
    op.drop_index(op.f('idx_orders_razorpay_order_id'), table_name='orders')
    op.drop_index(op.f('idx_orders_razorpay_payment_id'), table_name='orders')
    op.drop_index(op.f('idx_orders_session_id'), table_name='orders')
